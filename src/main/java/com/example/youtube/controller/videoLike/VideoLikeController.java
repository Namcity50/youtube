package com.example.youtube.controller.videoLike;
...
import com.example.youtube.service.videoLike.VideoLikeService;
...
public class VideoLikeController{
   ...
   // @PreAuthorize("hasRole('USER')")
    ...
    public ResponseEntity<VideoLikeResponseDTO> create(@Valid @RequestBody VideoLikeCreateDTO dto,
        ...
        VideoLikeResponseDTO result = videoLikeService.create(dto, getUserId());
    ...
    public ResponseEntity<Boolean> delete(@PathVariable Integer id,
        ...
        Boolean result = videoLikeService.deleteById(id, getUserId());
        return ResponseEntity.ok(result);
    }
