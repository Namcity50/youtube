package com.example.youtube.service.report;
...
import com.example.youtube.exps.ReportAlReadException;
import com.example.youtube.exps.ReportNotFoundException;
import com.example.youtube.repository.report.ReportRepository;
...
public class ReportService {
    ...
    public String add(ReportDTO dto, Language language) {
        ...
        if (entity != null) {
            throw new ReportAlReadException("report.alRead");
        }
