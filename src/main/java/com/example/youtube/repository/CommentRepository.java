...
public interface CommentRepository extends JpaRepository<CommentEntity, Integer> {
    ...
    List<CommentMapperDTO> findByProfileId(@Param("id")Integer id);
    ...
    List<CommentMapperInfoDTO> findByVideoId(@Param("id")Integer id);


    @Query(value = "select c.id as id from  comment as c where c.replay_id =:id ", nativeQuery = true)
    List<CommentMapperInfoDTO> findByCommentId(@Param("id")Integer id);
}
